...
A=cannon_trajectory(0,0,20,5)
A.calculate()
A.plot("red")
A=cannon_trajectory(0,0,20,10)
A.calculate()
A.plot("blue")
A=cannon_trajectory(0,0,20,15)
A.calculate()
A.plot("yellow")
A=cannon_trajectory(0,0,20,20)
A.calculate()
A.plot("pink")
A=cannon_trajectory(0,0,20,25)
A.calculate()
A.plot("purple")
A=cannon_trajectory(0,0,20,30)
A.calculate()
A.plot("black")
A=cannon_trajectory(0,0,20,35)
A.calculate()
A.plot("green")
A=cannon_trajectory(0,0,20,40)
A.calculate()
A.plot("orange")
A=cannon_trajectory(0,0,20,45)
A.calculate()
A.plot("brown")
A=cannon_trajectory(0,0,20,50)
A.calculate()
A.plot("gray")
A=cannon_trajectory(0,0,20,55)
A.calculate()
A.plot("cyan")
